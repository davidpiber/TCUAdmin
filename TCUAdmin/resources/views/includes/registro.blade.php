    ...
    <h3>Registrarse</h3>
            <form action="{{route('registrar')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="carnet_universidad">
                </div>
                <div class="form-group">
                    <label for="nombre">Correo Universidad:</label>
                    <input class="form-control" type="email" name="correo_universidad">
                </div>
                <div class="form-group">
                    <label for="email">Correo Personal:</label>
                    <input class="form-control" type="email" name="correo_personal">
                </div>
                <div class="form-group">
